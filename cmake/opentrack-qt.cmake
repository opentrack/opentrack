...
if(UNIX AND NOT APPLE)
    find_package(Qt6 OPTIONAL_COMPONENTS ${qt-optional-components} DBus)
    if(TARGET Qt6::DBus)
        if(LINUX)
            set(OPENTRACK_DBUS_CONTROL ON CACHE BOOL "Expose DBus services for control purposes")
        else()
            set(OPENTRACK_DBUS_CONTROL OFF CACHE BOOL "Expose DBus services for control purposes")
        endif()
...
find_package(Qt6 OPTIONAL_COMPONENTS ${qt-optional-components} QUIET)
