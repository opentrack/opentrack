...
if(OPENTRACK_DBUS_CONTROL OR APPLE)
    list(APPEND qt-required-components "DBus")
    list(APPEND qt-imported-targets Qt5::DBus)
endif()
if(APPLE)
    list(APPEND qt-optional-components "Multimedia")
    list(APPEND qt-imported-targets Qt5::Multimedia)
endif()
...
if(APPLE)
    list(APPEND MY_QT_LIBS ${Qt5Multimedia_LIBRARIES})
endif()
if (OPENTRACK_DBUS_CONTROL OR APPLE)
    list(APPEND MY_QT_LIBS ${Qt5DBus_LIBRARIES})
endif()
