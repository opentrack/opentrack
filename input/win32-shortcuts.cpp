...
//#define key_numpad(x) key_mod((x), (Qt::KeypadModifier))
    { Qt::Key_0,                        DIK_NUMPAD0,        VK_NUMPAD0,    },
    { Qt::Key_1,                        DIK_NUMPAD1,        VK_NUMPAD1,    },
    { Qt::Key_2,                        DIK_NUMPAD2,        VK_NUMPAD2,    },
    { Qt::Key_3,                        DIK_NUMPAD3,        VK_NUMPAD3,    },
    { Qt::Key_4,                        DIK_NUMPAD4,        VK_NUMPAD4,    },
    { Qt::Key_5,                        DIK_NUMPAD5,        VK_NUMPAD5,    },
    { Qt::Key_6,                        DIK_NUMPAD6,        VK_NUMPAD6,    },
    { Qt::Key_7,                        DIK_NUMPAD7,        VK_NUMPAD7,    },
    { Qt::Key_8,                        DIK_NUMPAD8,        VK_NUMPAD8,    },
    { Qt::Key_9,                        DIK_NUMPAD9,        VK_NUMPAD9,    },
    { Qt::Key_Comma,                    DIK_NUMPADCOMMA,    VK_SEPARATOR,  },
    { Qt::Key_Enter,                    DIK_NUMPADENTER,    VK_RETURN,     },
    { Qt::Key_Minus,                    DIK_NUMPADMINUS,    VK_SUBTRACT,   },
    { Qt::Key_Period,                   DIK_NUMPADPERIOD,   VK_DECIMAL,    },
    { Qt::Key_Plus,                     DIK_NUMPADPLUS,     VK_ADD,        },
    { Qt::Key_Slash,                    DIK_NUMPADSLASH,    VK_DIVIDE,     },
    { Qt::Key_multiply,                 DIK_NUMPADSTAR,     VK_MULTIPLY,   },
};
